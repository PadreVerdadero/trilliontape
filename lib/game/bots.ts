...
export const BOT_PROFILES: BotProfile[] = [
  ...
  },
  {
    username: "Reed",
    gold: 2200,
    specialty: ["berries", "fish", "honey", "bread", "wheat"],
    style: "tight",
  },
  {
    username: "Gossamer",
    gold: 2600,
    specialty: ["herbs", "flower", "shell", "salt", "bread"],
    style: "wide",
  },
  {
    username: "Anvil",
    gold: 3200,
    specialty: ["stone", "coal", "brick", "blade"],
    style: "tight",
  },
  {
    username: "Brine",
    gold: 2800,
    specialty: ["fish", "shell", "salt", "coral", "bread"],
    style: "wide",
  },
  {
    username: "Cinder",
    gold: 3000,
    specialty: ["planks", "brick", "candle", "coal", "blade"],
    style: "tight",
  },
  {
    username: "Nettle",
  ...
  },
  {
    username: "Drift",
    gold: 2700,
    specialty: ["fish", "flower", "honey", "shell", "wheat"],
    style: "wide",
  },
  {
    username: "Hearth",
    gold: 2500,
    specialty: ["bread", "honey", "wheat", "salt"],
    style: "tight",
  },
  {
    username: "Magpie",
    gold: 9000,
    specialty: ["gem", "honey", "mushrooms", "jewel", "coral"],
    style: "thin",
  },
  {
    username: "Wisp",
  ...
  },
  {
    username: "Soot",
    gold: 3100,
    specialty: ["coal", "stone", "brick", "blade"],
    style: "wild",
  },
  {
    username: "Vetch",
  ...
  },
  {
    username: "Gale",
    gold: 2900,
    specialty: ["fish", "salt", "shell", "coral", "honey"],
    style: "wild",
  },
  {
    username: "Bramble",
    gold: 2500,
    specialty: ["wood", "planks", "berries", "mushrooms", "flower"],
    style: "wide",
  },
  {
    username: "Yarrow",
    gold: 2700,
    specialty: ["flower", "honey", "herbs", "candle"],
    style: "wild",
  },
  {
    username: "Knurl",
    gold: 8200,
    specialty: ["stone", "coal", "gem", "jewel", "blade"],
    style: "thin",
  },
  {
    username: "Dusk",
  ...
  },
  {
    username: "Rill",
    gold: 2200,
    specialty: ["fish", "wheat", "salt", "bread", "honey"],
    style: "wide",
  },
  {
    username: "Quill",
    gold: 2600,
    specialty: ["wood", "planks", "flower", "wheat", "berries"],
    style: "wild",
  },
];
