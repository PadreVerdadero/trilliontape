...
3. A **leaders** tape at the top of the desk scrolls the top ten by net worth — hover to pause, yours is lit in gold if you are on that tape. Tap the tape to open the full leaderboard: coin, each good, and the money bag across the top, with that traveler’s counts in the cells below.
