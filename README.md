...
2. Your **pack** is the left rail: **Coins** first (how many you have), then **every** good with **Qty**, **MV**, **Avg** (the average price you paid for units you still hold — board fills at the trade price, other gains at MV), and **Total** (qty × MV). Goods you do not hold still appear at 0.
