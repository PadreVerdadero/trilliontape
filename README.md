...
3. A **leaders** tape at the top of the desk scrolls the top ten by net worth — hover to pause, yours is lit in gold if you are on that tape. Tap the tape to open the full leaderboard (place, traveler, coins, items at MV, net worth).
